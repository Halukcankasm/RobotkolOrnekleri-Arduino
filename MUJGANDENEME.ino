     ...
     i =0;                                     
               ...
               char bluetooth =Serial.read();
                 for(i=0;i<10;i++)
                 {
                     ...
                     if(Servo1_Hafiza[i] >0)
                     {
                     servo1.write(Servo1_Hafiza[i]);
                     delay(450);
                     }
                     
                     if(Servo2_Hafiza[i]>0)
                     {
                     servo2.write(Servo2_Hafiza[i]);
                     delay(450);
                     }
                     
                     if(Servo3_Hafiza[i]>0)
                     {
                     servo3.write(Servo3_Hafiza[i]); 
                     delay(450);
                     }
                     ...
                     if(Step1_Hafiza[i]!= 10000)   //->1.Step motorun derecesi kayıt derecesinde büyük ise döngüye gir!
                     {
                            while(step1sayici>Step1_Hafiza[i])
                            {                                         
                            digitalWrite(step1yon,0);                 //->Saat yönünün tersinde hareket et
                            stepmotor1.step(step1adim);               //->2 adım dön
                            step1sayici--;                            //->Adım azaltarak devam et
                            if(step1sayici==Step1_Hafiza[i])
                            {break;}  
                            }
                     }
                     ...
                     if(Step1_Hafiza[i]!= 10000)   //->1.Step motorun derecesi kayıt derecesinde küçük ise döngüye gir!
                     {  
                            while(step1sayici<Step1_Hafiza[i])
                            {                                       
                            digitalWrite(step1yon,1);     //->Saat yönününde hareket et
                            stepmotor1.step(step1adim);   //->2 adım dön
                            step1sayici++;                //->Adım arttırarak devam et
                    ...
                    if(Step2_Hafiza[i]!= 10000)
                    {
                              while(step2sayici>Step2_Hafiza[i])  //->2.Step motorun derecesi kayıt derecesinde büyük ise döngüye gir!
                              {         
                              digitalWrite(step2yon,0);           //->Saat yönünün tersinde hareket et
                              stepmotor2.step(step2adim);         //->2 adım dön
                              step2sayici--;                      //->Adım azaltarak devam et
                              if(step2sayici==Step2_Hafiza[i])
                              {break;}
                              } 
                    }    
                    ...
                    if(Step2_Hafiza[i]!= 10000)
                    {                                            
                              while(step2sayici<Step2_Hafiza[i]) //->2.Step motorun derecesi kayıt derecesinde küçük ise döngüye gir!
                              {      
                              digitalWrite(step2yon,1);          //->Saat yönününde hareket et
                              stepmotor2.step(step2adim);        //->2 adım dön
                              step2sayici++;                     //->Adım arttırarak devam et
                              if(step2sayici==Step2_Hafiza[i])
                              {break;}
                              }
                    }
                    ...
                    if(Step3_Hafiza[i]!= 10000)
                    {
                             while(step3sayici>Step3_Hafiza[i])
                             {         //
                             digitalWrite(step3yon,0);                 //
                             stepmotor3.step(step3adim);               //
                             step3sayici--;                            //
                             if(step3sayici==Step3_Hafiza[i]){break;}
                             } 
                    }    
                   ...
                   if(bluetooth=='p'){ break;}
                   Serial.println(bluetooth); 
               }//For(i=0;i<10;i++) döngüsünün sonu           
               if(i==10){i=0;}
               if(bluetooth=='p'){ break;}
           ...
           i=0;
                   for(i=0;i<10;i++)
                   {    
                   Servo1_Hafiza[i]=0;    Step1_Hafiza[i]=0;
                   Servo2_Hafiza[i]=0;    Step2_Hafiza[i]=0;
                   Servo3_Hafiza[i]=0;    Step3_Hafiza[i]=0;
                   if(i==10){break;}
                   }
           i=0;
           }
