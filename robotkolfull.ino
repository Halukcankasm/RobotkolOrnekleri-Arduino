...
static const int PIN_MAVI      = 22;
static const int PIN_PEMBE     = 23;
static const int PIN_SARI      = 24;
static const int PIN_TURUNCU   = 25;

static const int PIN2_MAVI      = 26;
static const int PIN2_PEMBE     = 27;
static const int PIN2_SARI      = 28;
static const int PIN2_TURUNCU   = 29;

static const int PIN3_MAVI      = 30;
static const int PIN3_PEMBE     = 31;
static const int PIN3_SARI      = 32;
static const int PIN3_TURUNCU   = 33;
...
void setup() {
  ...
  stepmotor3.setSpeed(5); //stepmotor hızı
   ...
   servo1.attach(13); //servo1 motorunun 6.pine bağlı
   servo2.attach(12); //servo1 motorunun 7.pine bağlı
...
pot2=map(analogRead(A7),0,1023,0,500);
pot3=map(analogRead(A6),0,1023,0,500);
